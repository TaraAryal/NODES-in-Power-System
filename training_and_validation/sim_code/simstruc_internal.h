 ...
 */
#define ssSetNumDWork_fwd(S, num) ((_ssSetNumDWork(S, num)) >= -1)
#define ssSetNumDWorkSLSize_fwd(S, num) ((_ssSetNumDWorkSLSize(S, num)) >= -1)
...
#define ssGetNumDWorkSLSize_fwd(S) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numDWork
#define ssGetNumDWork_fwd(S) (S)->sizes.numDWork

/*
 * Set/Get number continuous states
 */
#define ssGetNumContStatesSLSize_fwd(S) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numContStates
#define ssGetNumContStates_fwd(S) (S)->sizes.numContStates
#define ssGetNumContStatesAsInt(S) (S)->sizes.numContStates
#define ssSetNumContStatesSLSize_fwd(S, nContStates) \
    ((S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numContStates = (nContStates))
#define ssSetNumContStates_fwd(S, nContStates) ((S)->sizes.numContStates = (nContStates))

/*
 * Set/Get number discrete states
 */
#define ssGetNumDiscStatesSLSize_fwd(S) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numDiscStates
#define ssGetNumDiscStates_fwd(S) (S)->sizes.numDiscStates
#define ssSetNumDiscStatesSLSize_fwd(S, nDiscStates) \
    (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numDiscStates = (nDiscStates)
#define ssSetNumDiscStates_fwd(S, nDiscStates) (S)->sizes.numDiscStates = (nDiscStates)

/*
 * Set/Get number of nonsampled zero-crossings
 */
#define ssGetNumNonsampledZCsSLSize_fwd(S) \
    (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numNonsampledZCs
#define ssGetNumNonsampledZCs_fwd(S) (S)->sizes.numNonsampledZCs
#define ssSetNumNonsampledZCsSLSize_fwd(S, nNonsampledZCs) \
    ((S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numNonsampledZCs = (nNonsampledZCs))
#define ssSetNumNonsampledZCs_fwd(S, nNonsampledZCs) \
    ((S)->sizes.numNonsampledZCs = (nNonsampledZCs))

/*
 * Set/Get number of RWork elements
 */
#define ssGetNumRWorkSLSize_fwd(S) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numRWork
#define ssGetNumRWork_fwd(S) (S)->sizes.numRWork
#define ssSetNumRWorkSLSize_fwd(S, nRWork) \
    (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numRWork = (nRWork)
#define ssSetNumRWork_fwd(S, nRWork) (S)->sizes.numRWork = (nRWork)

/*
 * Set/Get number of IWork elements
 */
#define ssGetNumIWorkSLSize_fwd(S) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numIWork
#define ssGetNumIWork_fwd(S) (S)->sizes.numIWork
#define ssSetNumIWorkSLSize_fwd(S, nIWork) \
    (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numIWork = (nIWork)
#define ssSetNumIWork_fwd(S, nIWork) (S)->sizes.numIWork = (nIWork)

/*
 * Set/Get number of PWork elements
 */
#define ssGetNumPWorkSLSize_fwd(S) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numPWork
#define ssGetNumPWork_fwd(S) (S)->sizes.numPWork
#define ssSetNumPWorkSLSize_fwd(S, nPWork) \
    (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numPWork = (nPWork)
#define ssSetNumPWork_fwd(S, nPWork) (S)->sizes.numPWork = (nPWork)

/*
 * Set/Get number of modes
 */
#define ssGetNumModes_fwd(S) (S)->sizes.numModes
#define ssGetNumModesSLSize_fwd(S) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numModes
#define ssSetNumModes_fwd(S, n) (S)->sizes.numModes = (n)
#define ssSetNumModesSLSize_fwd(S, n) (S)->blkInfo.blkInfo2->blkInfoSLSize->sizes.numModes = (n)
 ...
 */
# if (SS_SFCN_FOR_SIM)
    extern void _ssRegisterSymbolicEqualValue(SimStruct *S, 
                                                      const SymbDimsId aLHS,
                                                      const int_T aValue);
#   define ssRegisterSymbolicEqualValue(S, aLHS, aValue) \
    _ssRegisterSymbolicEqualValue(S, aLHS, aValue)
# else
#   define ssRegisterSymbolicEqualValue(S, aLHS, aValue)
# endif
...
#define ssAmendLeadingSymbolicDims(S, numDims, aDimsId) _ssAmendLeadingSymbolicDims(S, numDims, aDimsId)
#else
 ...
 */
    ...
    extern SymbDimsId _ssAmendTrailingSymbolicDims(SimStruct* S,
                                           const int_T numDims,
                                           const SymbDimsId aDimsId);
#define ssAmendTrailingSymbolicDims(S, numDims, aDimsId) _ssAmendTrailingSymbolicDims(S, numDims, aDimsId)
#else
...
#define ssGetNoZCStateUpdate(S) (S)->mdlInfo->mdlFlags.noZCStateUpdate /*  (int_T)    */
#define _ssSetNoZCStateUpdate(S) ((S)->mdlInfo->mdlFlags.noZCStateUpdate = 1U)
#define _ssClearNoZCStateUpdate(S) ((S)->mdlInfo->mdlFlags.noZCStateUpdate = 0U)
#if !SS_SFCN
#define ssClearNoZCStateUpdate(S) _ssClearNoZCStateUpdate(S)
#define ssSetNoZCStateUpdate(S) _ssSetNoZCStateUpdate(S)
#else
#define ssClearNoZCStateUpdate(S) ssClearNoZCStateUpdate_cannot_be_used_in_SFunctions
#define ssSetNoZCStateUpdate(S) ssSetNoZCStateUpdate_cannot_be_used_in_SFunctions
#endif
...
#define ssGetIsMinorOutputWithModeChange(S) \
    (S)->mdlInfo->solverInfo->isMinorOutputWithModeChange /*  (boolean_T)  */
#define ssSetIsMinorOutputWithModeChange(S) \
          (S)->mdlInfo->solverInfo->isMinorOutputWithModeChange = 1U
#define ssClearIsMinorOutputWithModeChange(S) \
    (S)->mdlInfo->solverInfo->isMinorOutputWithModeChange = 0U

#define ssGetIsOkayToUpdateMode(S)             \
    ((S)->mdlInfo->simTimeStep == MAJOR_TIME_STEP || ssGetIsMinorOutputWithModeChange(S))
...
#define ssSetSolverZeroCrossAlgorithm(S, val) ssGetSolverInfo(S)->zeroCrossAlgorithm = (val)
#define ssGetSolverZeroCrossAlgorithm(S) ssGetSolverInfo(S)->zeroCrossAlgorithm
...
#define ssSetModelOutputs(S, fcn) (S)->modelMethods.sFcn.mdlOutputs.level2 = (mdlOutputsFcn)(fcn)
#define ssRunModelOutputs(S, tid) \
        (*((voidFcnIntType)((S)->modelMethods.sFcn.mdlOutputs.level2)))(tid)


#define ssSetModelUpdate(S, fcn) (S)->modelMethods.sFcn.mdlUpdate.level2 = (mdlUpdateFcn)(fcn)
#define ssRunModelUpdate(S, tid) (*((voidFcnIntType)((S)->modelMethods.sFcn.mdlUpdate.level2)))(tid)
...
#define ssIsCombineCompExecUserData(S) \
    ((S)->blkInfo.sfcnFlags.ssCombineCompExecUserData == 1U)
 ...
 * LocalWords:  elif ID's EXTLOGTASK ONESHOT ir Lcs dworks dstates fcncall DWork Vec Bds
