...
typedef int_T (*GetGenericDTADiagnostic) (void *, const char_T *,
                                          ...
                                          BDErrorValue *);
#ifdef INT64_T
typedef const void* (*GetGenericDTAVoidElemProp64) (void *, const char_T *,
                                                  DTypeId, int64_T,
                                                  GenDTAVoidElemPropType);
typedef int_T (*SetGenericDTAVoidElemProp64) (void *, const char_T *, DTypeId,
                                 int64_T, const void *, GenDTAVoidElemPropType);

typedef int_T (*GetGenericDTAIntElemProp64) (void *, const char_T *, DTypeId,
                                           int64_T, GenDTAIntElemPropType);
typedef int_T (*SetGenericDTAIntElemProp64) (void *, const char_T *, DTypeId,
                                           int64_T, int_T, GenDTAIntElemPropType);
typedef real_T (*GetGenericDTARealElemProp64) (void *, const char_T *, DTypeId,
                                            int64_T, GenDTARealElemPropType);
typedef int_T  (*SetGenericDTARealElemProp64) (void *, const char_T *, DTypeId,
                                               int64_T, int_T, GenDTARealElemPropType);
#else
typedef const void* (*GetGenericDTAVoidElemProp64) (void *, const char_T *,
                                                  DTypeId, int_T,
                                                  GenDTAVoidElemPropType);
