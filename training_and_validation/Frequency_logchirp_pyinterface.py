...
class Frequency_logchirp:
    def __init__(self, out_lib_name: str="Frequency_logchirp_lib.so", compile: bool=True):
        """
        ...
        self.Frequency_logchirp_system = ctypes.cdll.LoadLibrary(os.path.join(filepath, out_lib_name))
    ...
    def reset(self, ):
        ...
        self.current_time = self.start_time
        self.next_time = self.current_time + self.step_time
        self.Frequency_logchirp_system.initialize( self.inputpower1, self.deltaomega, self.deltaomegadot)
    ...
    def one_step(self, ):
        ...
        """
        self.Frequency_logchirp_system.one_step( self.inputpower1, self.deltaomega, self.deltaomegadot)
...
#         raise Exception("Stop time not specified. Type `python Frequency_logchirp_pyinterface.py --help` for more info!!!")
...
#     m = Frequency_logchirp("Frequency_logchirp_lib.so", step_time=STEP_TIME, compile=True)
...
#     hf = h5py.File("Frequency_logchirp_out.h5", "w")
